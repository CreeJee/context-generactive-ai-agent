import { KeyRoundIcon, SettingsIcon, Trash2Icon } from "lucide-react";
...
import { ApiError, api, type KagiStatus } from "./api";
...
/** Settings that apply beyond one conversation: web search, and later MCP servers and skills. */
